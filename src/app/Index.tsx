    ...
    return (
        <View style={styles.container}>
          ...
          <View style={styles.verRegistros}>
            <Text style={styles.tituloReg}>  Registros</Text>
                ...
                <TouchableOpacity style={styles.categorias}>
                  ...
                  <TouchableOpacity style={styles.categorias}>
                    <Text style={styles.estiloCat}>Material </Text>
                </TouchableOpacity>
                  <TouchableOpacity style={styles.categorias}>
                    <Text style={styles.estiloCat}>Esponjas</Text>
                </TouchableOpacity>
                  <TouchableOpacity style={styles.categorias}>
                    <Text style={styles.estiloCat}>Eletrônicos</Text>
                </TouchableOpacity>
          ...
          <View style={styles.registrar}>
            ...
            <TouchableOpacity style={styles.botaoRegistrar} onPress={() => navigation.navigate('Registrar')}><Text style={styles.textoRegistrar}>Registrar</Text></TouchableOpacity>
          </View>
